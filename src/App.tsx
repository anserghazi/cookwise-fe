...
function App() {
  ...
  const [fabStyle, setFabStyle] = useState(isMobile ? {position: 'absolute', color: 'white', top: 15, left: 22, borderRadius: '20px', borderStyle: 'solid', borderWidth: '1px', borderColor: 'rgb(0, 68, 68)', paddingTop: '11px', paddingBottom: '0px', paddingLeft: '1px', boxShadow: 'none', overflow: 'hidden', backgroundColor: '#060b0f', '&:hover': {backgroundColor: '#282c34'}}
  ...
  useEffect(() => {
    if (isMobile) {
      if (menu) {
        ...
        setFabStyle({position: 'absolute', color: 'white', top: 15, left: 25, borderRadius: '20px', borderStyle: 'solid', borderWidth: '1px', borderColor: 'rgb(0, 68, 68)', paddingTop: '11px', paddingBottom: '0px', paddingLeft: '1px', boxShadow: 'none', overflow: 'hidden', backgroundColor: '#111418', '&:hover': {backgroundColor: '#282c34'}})
      }
      setFabSize("large")
    }
    else {
  ...
  function toggleMenu() {
    ...
    if (menu === true) {
      ...
      if (isMobile) {
        setFabStyle({position: 'absolute', color: 'white', top: 15, left: 25, borderRadius: '20px', borderStyle: 'none', borderWidth: '1px', borderColor: 'rgb(0, 68, 68)', paddingTop: '11px', paddingBottom: '0px', paddingLeft: '1px', boxShadow: 'none', overflow: 'hidden', backgroundColor: '#060b0f', '&:hover': {backgroundColor: '#4A515A'}});
      }
      else {
      ...
      if (isMobile) {
        setFabStyle({position: 'absolute', color: 'white', top: 15, left: 25, borderRadius: '10px', borderStyle: 'solid', borderWidth: '1px', borderColor: 'rgb(0, 68, 68)', paddingTop: '11px', paddingBottom: '0px', paddingLeft: '1px', boxShadow: 'none', overflow: 'hidden', backgroundColor: '#111418', '&:hover': {backgroundColor: '#282c34'}});
      }
      else {
